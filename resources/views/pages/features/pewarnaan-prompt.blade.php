                    ...
                    <div id="advanced-content" class="hidden px-4 pb-4 space-y-4 border-t border-gray-800 pt-4 bg-gray-800/20">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center text-xs">
                                ...
                                <span id="steps-val" class="text-amber-500 font-mono">20</span>
                            </div>
                            <input type="range" id="steps" min="5" max="40" step="1" value="20" class="w-full accent-amber-500 h-1.5 bg-gray-700 rounded-lg appearance-none cursor-pointer" oninput="document.getElementById('steps-val').textContent = this.value">
                        </div>
