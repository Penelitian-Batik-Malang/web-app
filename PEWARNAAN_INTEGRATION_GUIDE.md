...
ML_FASHION_URL=http://localhost:5000
```

**Penjelasan:**

- `ML_FASHION_URL`: Base URL backend API untuk fashion/pewarnaan (localhost port 5000)
- Endpoint akan di-append otomatis: `/api/palette/extract` dan `/api/recolor`
